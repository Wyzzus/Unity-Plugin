...
#### 4.0.10
Update the navisens core to v1.7.7 for both Android and iOS.
...
- [# Navisens/Unity-Plugin](#navisensunity-plugin)
- [Download](#download)
...
- [Actions](#actions)
    ...
    - [`MotionDna.StopUDP()`](#motiondnastopudp)
    - [`MotionDna.SendUDP(string message)`](#motiondnasendudpstring-message)
    - [`MotionDna.QueryUDPRooms(string[] rooms)`&dagger;](#motiondnaqueryudproomsstring-roomsdagger)
    - [`MotionDna.ResetLocalEstimation()`](#motiondnaresetlocalestimation)
- [Getters](#getters)
    - [Example](#example)
    ...
    - [`Vector3 MotionDna.Position`](#vector3-motiondnaposition)
    - [`Vector3? MotionDna.GetLocalPosition(string deviceID = null)`](#vector3-motiondnagetlocalpositionstring-deviceid--null)
    ...
    - [`Vector2 MotionDna.Uncertainty`](#vector2-motiondnauncertainty)
    - [`Vector2? MotionDna.GetUncertainty(string deviceID = null)`](#vector2-motiondnagetuncertaintystring-deviceid--null)
...
- [Callbacks](#callbacks)
  ...
  - [IMotionDnaUDPListener](#imotiondnaudplistener)
    - [`.OnReceiveUDP(string, string)`](#onreceiveudpstring-string)
    - [`.OnReceiveUDPDeviceLimit()`](#onreceiveudpdevicelimit)
    - [`.OnReceiveUDPServerLimit()`](#onreceiveudpserverlimit)
    - [`.OnReceiveUDPRooms(Dictionary)`&dagger;](#onreceiveudproomsdictionarydagger)
